...
void FwLoopHSliderLayout::init(const QList<FwPrimitive*> items, FwPrimitive* current, const QRect& rect)
{
    Q_UNUSED(current);
...
void FwLoopVSliderLayout::init(const QList<FwPrimitive*> items, FwPrimitive* current, const QRect& rect)
{
    Q_UNUSED(current);
