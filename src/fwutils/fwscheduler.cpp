...
//        event->setStatus(FwScheduler::TS_Start);
...
//    {
//        FwSchedulerTaskEvent* event = new FwSchedulerTaskEvent();
//        event->setStatus(FwScheduler::TS_Stop);
//        QCoreApplication::postEvent(task, event);
//        return true;
//    }
//    return false;
...
//{
//    if(m_status != FwScheduler::TS_Stop)
//    {
//        m_status = FwScheduler::TS_Stop;
//        killTaskTimer();
//    }
...
//{
//    if(m_status == FwScheduler::TS_Pause)
//    {
//        m_status = FwScheduler::TS_Start;
//        startTaskTimer();
//    }
...
//{
//    if(m_status == FwScheduler::TS_Start)
//    {
//        m_status = FwScheduler::TS_Pause;
//        killTaskTimer();
//    }
//}
...
//        {
//        case FwScheduler::TS_Start:
//            start();
//            taskEvent->accept();
//            return true;

//        case FwScheduler::TS_Stop:
//            stop();
//            taskEvent->accept();
//            return true;
//        }
...
//{
//    if(event->timerId() == m_timerId && m_status == FwScheduler::TS_Start)
//    {
//        run();
//    }
//}
...
//            {
//                qDebug() << e.error();
//                setMasterStatus(FwNetworkSchedulerTask::Continue);
//            }
//        }
//        else
//        {
...
//        if(masterStatus() == FwNetworkSchedulerTask::ContinueWhenReady && m_slaves.isEmpty())
//        {
//            setMasterStatus(FwNetworkSchedulerTask::Continue);
//        }
//        return;
