...
"false", "no", "true", "yes".
\return � езультат преобразования строки к типу bool
...
\return � езультат выражения value() == 0
*/
...
\param bOk Успешность выполнения операции, значение переменной после
ыполнения функции всегда равно true
\return � езультат выражения qFuzzyCompare(value(), 0.)
*/
...
/*!
� азбирает данные, переданные в параметре utf8String, и строит по ним дерево.
...
/*!
� азбирает данные прочитанные из QIODevice и строит по ним дерево.
...
\return � езультат преобразования значения первого элемента к int
*/
...
\param bOk Успешность выполнения операции
\return � езультат преобразования значения первого элемента к bool
*/
