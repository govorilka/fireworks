...
//    inline void bindColor(int index, const FwColor& color);
//    inline void bindUrl(int index, const QUrl& url);
//    inline void bindDateTime(int index, const QDateTime& datetime);
...
//void FwPg::QueryData::bindColor(int index, const FwColor& color)
//{
//    bindInt(index, color.argb());
//}

//void FwPg::QueryData::bindUrl(int index, const QUrl& url)
//{
//    bindText(index, url.toString());
//}

//void FwPg::QueryData::bindDateTime(int index, const QDateTime& datetime)
//{
//    bindText(index, datetime.toString());
//}
////////////////////////////////////////////////////////////////////////////////////
